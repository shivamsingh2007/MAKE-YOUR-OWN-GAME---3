...
function setup() {
  ...
  ground = createSprite(0, 150, 0, 0);
  ground.shapeColor = "white";
  ground.addImage("ground_image", ground_image);
  ground.scale = 1.4;
  ground.velocityX = -1

stopper = createSprite(300,95,50,10)
stopper.visible = false
  ...
  zombie = createSprite(50, 180, 600, 10);
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    var obstacle = createSprite(600, 264, 10, 40);
